...
print "", num_desired_got_reply, num_desired_no_reply, num_no_desire_got_reply, num_no_desire_no_reply
print "With question, the response percentage is %0.5f" % (float(num_desired_got_reply) / (num_desired_got_reply + num_desired_no_reply))
print "Without question, the response percentage is %0.5f" % (float(num_no_desire_got_reply) / (num_no_desire_got_reply + num_no_desire_no_reply))
